...
public class Four {
    ...
    static int N, M;
    static int B; // 총 세울 수 있는 벽의 개수 == 0 의 갯수
    static int ans;
    static int[][] A;
    static int[][] blank; // 세울 수 있는 벽의 위치를 저장
    // ex) 1번 벽 --> blank[0][0] = i, blank[0][1] = j
    ...
    static void bfs() {
        ...
        /**
         * MultiSource BruteForce : 가능한 시작점을 다 넣고 돌린다.
         **/
